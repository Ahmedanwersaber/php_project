...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2022 at 04:25 PM
...
INSERT INTO `comment` (`Cid`, `CBody`, `Uid`, `Pid`) VALUES
(1, '[sample comment]', 3, 1),
(2, '[sample comment 2]', 1, 1),
(3, 'Congrats!', 4, 2),
(4, 'Good job', 6, 4);
...
--
ALTER TABLE `comment`
  MODIFY `Cid` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
